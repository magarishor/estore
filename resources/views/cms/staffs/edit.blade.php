                ...
                <div class="col-5 mx-auto">
                    <form action="{{ route('cms.staffs.update', $staff->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control-plaintext" value="{{ $staff->email }}">
                        </div>
                        <div class="mb-3">
                            <label for="name" class="form-label">Phone</label>
                            <input type="text" name="phone" id="name" class="form-control" value="{{ old('phone', $staff->phone) }}" required>
                        </div>
                        <div class="mb-3">
